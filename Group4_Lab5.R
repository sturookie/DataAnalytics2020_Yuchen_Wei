...
colnames (heartdata) <- c("age","sex","cp","trestbps","chol"," fbs","restecg","thalach","exang","oldpeak","slope","thal","hd")
head(heartdata)
str(heartdata)
...
heartdata$hd <-ifelse(test = heartdata$hd , yes = "Healthy", no = "Unhealthy")
